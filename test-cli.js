...
const testDir = '/tmp/kit-dot-test-project';

async function runTest() {
  console.log('🧪 Testing kit-dot CLI...');
  ...
  const helpProcess = spawn('node', ['dist/cli.js', '--help'], {
    cwd: '/Users/nomadbitcoin/Projects/kit-dot',
    stdio: 'inherit'
  });
  ...
  try {
    ...
    console.log('🎉 All tests passed! kit-dot CLI is working correctly.');
